...
class advertisement(models.Model):
    ...
    Userfacebook = models.CharField(default = None, max_length=50, blank=True  )
    UserInstagram = models.CharField(default = None, max_length=50, blank=True  )
    UserTwitter = models.CharField(default = None, max_length=50, blank=True  )
    ...
    whatsapp = models.CharField(max_length=11, default=None, blank=True  )
    show_phones = models.BooleanField(default=False, blank=True  )
    email = models.EmailField(max_length=254, default=None, blank=True  )                
    url_website = models.URLField(max_length=200, default=None, blank=True  )
    ...
    show_adress = models.BooleanField(default=False, blank=True  )
